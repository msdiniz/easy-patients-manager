...
describe.only('ApiDataSource', () => {
  ...
  it('should fetch all contacts', async () => {
    ...
    (google.people({ version: 'v1' }).people.connections.list as jest.Mock).mockResolvedValue({
  ...
  it('should fetch a single contact', async () => {
    ...
    (google.people({ version: 'v1' }).people.get as jest.Mock).mockResolvedValue({ data: mockContact });
  ...
  it('should create a contact', async () => {
    ...
    (google.people({ version: 'v1' }).people.createContact as jest.Mock).mockResolvedValue({ data: createdContact });
  ...
  it('should update a contact', async () => {
    ...
    (google.people({ version: 'v1' }).people.updateContact as jest.Mock).mockResolvedValue({ data: updatedContact });
  ...
  it('should delete a contact', async () => {
    (google.people({ version: 'v1' }).people.deleteContact as jest.Mock).mockResolvedValue({});
